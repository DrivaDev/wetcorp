  ...
  return (
    <div className="bg-fondo min-h-screen">
      <header className="bg-white border-b border-acento px-4 sm:px-8 py-4">
        <div className="max-w-5xl mx-auto flex flex-col gap-2">
          ...
          <div className="flex items-center justify-between gap-4 flex-wrap">
            ...
            <div className="h-9 w-20 rounded-lg bg-acento/30 animate-pulse" />
          </div>
        </div>
      </header>
      <main className="px-4 sm:px-8 py-6 max-w-5xl mx-auto flex flex-col gap-6 animate-pulse">
        ...
        <div className="rounded-xl border border-acento bg-white p-6">
          <div className="h-5 w-24 rounded bg-acento/30 mb-4" />
          {Array.from({ length: 3 }).map((_, i) => (
            <div key={i} className="h-14 rounded-lg bg-acento/20 mb-2" />
          ))}
          <div className="h-px bg-acento/50 my-3" />
          <div className="flex justify-between">
            <div className="h-4 w-20 rounded bg-acento/30" />
        ...
        {Array.from({ length: 3 }).map((_, i) => (
          <div key={i} className="rounded-xl border border-acento bg-white p-6">
            ...
            <div className="flex justify-between mt-4 pt-4 border-t border-acento/50">
              <div className="h-4 w-16 rounded bg-acento/30" />
              <div className="h-5 w-24 rounded bg-acento/30" />
            </div>
          </div>
        ))}
        ...
        <div className="rounded-xl border border-acento bg-white divide-y divide-acento/40">
          {Array.from({ length: 4 }).map((_, i) => (
            <div key={i} className="flex items-center gap-3 px-4 py-3">
              <div className="h-4 w-4 rounded bg-acento/30" />
